...
| **Transition Function ($f$)**   | Leaky Integrate-and-Fire (LIF) primitive: $f(\epsilon_n, x_n) = (\epsilon_n >> 1) + x_n$ |
| **Temporal Resolution ($\Delta t$)** | Deterministic execution, jitter $< 0.5\mu s$                        |
